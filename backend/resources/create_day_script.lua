...
--- It the day isn't already present, then it is added to both the Hash for that day and to the set for keeping tabs
--- on users days.
--- KEYS:
...
--- Return:
---     0 if the entry already exists or the user doesn't
