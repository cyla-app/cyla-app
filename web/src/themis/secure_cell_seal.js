...
class SecureCellSeal {
    ...
    encrypt(message) {
        ...
        let result_length_ptr = init.libthemis.allocate(new ArrayBuffer(4), init.libthemis.ALLOC_STACK)
        ...
        try {
            ...
            status = init.libthemis._themis_secure_cell_encrypt_seal(
            ...
            result_length = init.libthemis.getValue(result_length_ptr, 'i32')
    ...
    decrypt(message) {
        ...
        try {
            ...
            status = init.libthemis._themis_secure_cell_decrypt_seal(
                master_key_ptr, this.masterKey.length,
                context_ptr, context.length,
                message_ptr, message.length,
                null, result_length_ptr
...
class SecureCellSealWithPassphrase extends SecureCellSeal {
    ...
    encrypt(message) {
        ...
        try {
            ...
            status = init.libthemis._themis_secure_cell_encrypt_seal_with_passphrase(
                master_key_ptr, this.masterKey.length,
                context_ptr, context.length,
                message_ptr, message.length,
                null, result_length_ptr
    ...
    decrypt(message) {
        ...
        try {
            ...
            status = init.libthemis._themis_secure_cell_decrypt_seal_with_passphrase(
                master_key_ptr, this.masterKey.length,
                context_ptr, context.length,
                message_ptr, message.length,
                null, result_length_ptr
